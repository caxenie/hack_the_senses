# spatialize a sound in azimuth on the horizontal plane
...
for az in range(0, 180, 5): # from 0-180 degrees with 5 deg resolution
    # choose the desired HRTF
    ...
    check_call(['sox', 'out.wav', oname + '.wav'])	
